      ...
      <div className="flex flex-col gap-3 w-full">
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <motion.button
            ...
            className="flex-1 inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-forest text-cream font-semibold rounded-full shadow-md hover:bg-forest-mid hover:shadow-lg transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-gold"
          >
          ...
          <motion.a
            ...
            className="flex-1 inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-full font-semibold text-white focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2"
            style={{
